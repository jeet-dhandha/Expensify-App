const emojiMap = {
    ...
    '🫣': {name: 'face_with_peeking_eye', code: '🫣', keywords: []},
    '🫡': {name: 'saluting_face', code: '🫡', keywords: ['respect']},
    '🫥': {name: 'dotted_line_face', code: '🫥', keywords: ['invisible']},
    '🫤': {
    ...
    '🫱': {name: 'rightwards_hand', code: '🫱', keywords: []},
    '🫲': {name: 'leftwards_hand', code: '🫲', keywords: []},
    '🫳': {name: 'palm_down_hand', code: '🫳', keywords: []},
    '🫴': {name: 'palm_up_hand', code: '🫴', keywords: []},
    '🫰': {
        name: 'hand_with_index_finger_and_thumb_crossed',
        code: '🫰',
        keywords: [],
    },
    '🫵': {name: 'index_pointing_at_the_viewer', code: '🫵', keywords: []},
    '🫶': {name: 'heart_hands', code: '🫶', keywords: ['love']},
    '🫦': {name: 'biting_lip', code: '🫦', keywords: []},
    '🫅': {name: 'person_with_crown', code: '🫅', keywords: []},
    '🫃': {name: 'pregnant_man', code: '🫃', keywords: []},
    '🫄': {name: 'pregnant_person', code: '🫄', keywords: []},
    '🧌': {name: 'troll', code: '🧌', keywords: []},
    '🪸': {name: 'coral', code: '🪸', keywords: []},
    '🪷': {name: 'lotus', code: '🪷', keywords: []},
    '🪹': {name: 'empty_nest', code: '🪹', keywords: []},
    '🪺': {name: 'nest_with_eggs', code: '🪺', keywords: []},
    '🫘': {name: 'beans', code: '🫘', keywords: []},
    '🫗': {name: 'pouring_liquid', code: '🫗', keywords: []},
    '🫙': {name: 'jar', code: '🫙', keywords: []},
    '🛝': {name: 'playground_slide', code: '🛝', keywords: []},
    '🛞': {name: 'wheel', code: '🛞', keywords: []},
    '🛟': {name: 'ring_buoy', code: '🛟', keywords: ['life preserver']},
    '🪩': {name: 'mirror_ball', code: '🪩', keywords: ['disco', 'party']},
    '🪫': {name: 'low_battery', code: '🪫', keywords: []},
    '🩼': {name: 'crutch', code: '🩼', keywords: []},
    '🩻': {name: 'x_ray', code: '🩻', keywords: []},
    '🫧': {name: 'bubbles', code: '🫧', keywords: []},
    '🪬': {name: 'hamsa', code: '🪬', keywords: []},
    '🪪': {name: 'identification_card', code: '🪪', keywords: []},
    '🟰': {name: 'heavy_equals_sign', code: '🟰', keywords: ['equal']},
};
